<script>
  ...
  function main1() {
    ...
    d3.csv(
      'https://rawgit.com/sgratzl/d3tutorial/master/examples/titanic3.csv',
    ).then((parsed) => {
    ...
    //interactivity
    d3.select('#passenger-class').on('change', function (e) {
      // console.log(`e`, e)
      // const selected = d3.select(this).property('value')
      state.passengerClass = e.target.value
      updateApp()
    })
  }
